...
public class Constants { //TODO: play with these values once we get a robot
	public static final double kLookaheadDistance = 20.0; //in inches; use a fixed lookahead for now; 254 uses a varying lookahead based on speed
...
//	public static final double kTurnAccelCoefficient = 0.6; // the percent of acceleration dedicated to turning per ft/sec of differential error - creates max turning accel
	public static final double kTurnVelCoefficient = 1; // the percent of velocity that will be used as a differential per radian of angular error - creates vel diff setpoint
//	public static final double kTurningVelocity = 60; 
	
	public static final double kMaxAccelSpeedUp = 1; //in inches/sec^2; the max acceleration the robot can be commanded to experience when traveling a path
	public static final double kMaxAccelTurning = 10000;
	
	public static final double kWheelDiameter = 6; // in inches; the diameter of the drive wheels
	public static final double kWheelBase = 25; //in inches; the distance between the left and right drive wheels
