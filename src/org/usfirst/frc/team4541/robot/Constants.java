...
public class Constants { //TODO: play with these values once we get a robot
	public static final double kLookaheadDistance = 10; //in inches; use a fixed lookahead for now; 254 uses a varying lookahead based on speed
...
//	public static final double kMaxAccelTurning = 20;
	public static final double kMaxTurningVelocity = 15;
