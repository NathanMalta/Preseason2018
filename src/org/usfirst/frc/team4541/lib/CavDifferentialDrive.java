 ...
 */
public class CavDifferentialDrive extends RobotDriveBase {
   ...
   */
  public CavDifferentialDrive(SpeedController leftMotor, SpeedController rightMotor) {
  ...
  public void curvatureDrive(double xSpeed, double zRotation, boolean isQuickTurn) {
    ...
    //Note neither is negative because positive is forward for both drive motors
