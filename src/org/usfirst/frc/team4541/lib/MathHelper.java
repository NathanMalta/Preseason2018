...
public class MathHelper {
	 ...
	 */
	public static double getLeftVelocityTargetForConstantRadiusTurn(double currentVel, double turnRad) {
		return currentVel * (turnRad - (Constants.kWheelBase / 2)) / turnRad;
	}
	 ...
	 */
	public static double getRightVelocityTargetForConstantRadiusTurn(double currentVel, double turnRad) {
		return currentVel * (turnRad + (Constants.kWheelBase / 2)) / turnRad;
	}
}
